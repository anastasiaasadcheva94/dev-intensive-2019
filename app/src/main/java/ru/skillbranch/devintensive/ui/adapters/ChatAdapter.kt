...
class ChatAdapter(val listener: (ChatItem) -> Unit) : RecyclerView.Adapter<ChatAdapter.ChatItemViewHolder>() {
    ...
    inner class SingleViewHolder(containerView:View) : ChatItemViewHolder(containerView), LayoutContainer, ItemTouchViewHolder {
    ...
    inner class GroupViewHolder(containerView:View) : ChatItemViewHolder(containerView), ItemTouchViewHolder {
        override fun bind(item:ChatItem, listener: (ChatItem) -> Unit){
