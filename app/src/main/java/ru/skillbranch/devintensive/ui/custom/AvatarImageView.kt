...
class AvatarImageView @JvmOverloads constructor(
    ...
    companion object{
        private const val DEFAULT_BORDER_WIDTH = 2 //ctrl+shift+u смена регистра
...
init {
    if (attrs != null){
        ...
        ta.recycle() //высвободить атрибуты после их прочтения из xml! эффективнее используются ресурсы

    }
    scaleType = ScaleType.CENTER_CROP
    setup()
    //setOnClickListener{handleLongClick()} //или : onLongClickListener на view. Смена аватара на инициалы
}
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawOval(borderRect.toRectF(), borderPaint)//обводка
    }
